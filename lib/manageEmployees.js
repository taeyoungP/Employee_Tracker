...
async function main() {
    ...
    init(db); //Start and initate employee manager
...
async function init(db) {
    //Whenever goes back to menu, end current opened database and make a new connection to retrieve updated database
    db.end();
